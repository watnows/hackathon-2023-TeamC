...
export default function Mailedit() {
    const [text, setText] = useState("yukina");
    ...
    return (
        <div style={{ width: '100%', height: "100vh" }}>
            ...
            <div style={{ background: 'lightgray', width: '70%', margin: 'auto', marginTop: 35, height: '60%', overflow: 'scroll', position: 'relative' }} className="scroll-mail"><div style={{ width: '95%', height: '100%', float: 'left' }}><textarea disabled={judge} style={{ width: '100%', height: '100%', border: 'none', resize: 'none', background: 'lightgray', outline: 'none' }} onChange={onHandleSetText}>{text}</textarea></div><img src="/logo_copy.svg" style={{ width: '5%', position: 'absolute', bottom: 10, right: 10 }} onClick={copyText}></img></div>
