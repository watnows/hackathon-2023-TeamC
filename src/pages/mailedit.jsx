    ...
    return (
        ...
        <div style={{ color: 'white', fontSize: 45, textAlign: 'center', letterSpacing: 8, fontFamily: 'Nico Moji', marginTop: 5 }}>シューカツメールつくるくん</div>
            ...
            <div style={{ float: "left", marginTop: 60, width: '100%', textAlign: 'center' }}>
                ...
                <button style={{ border: 'none', letterSpacing: 3, paddingLeft: 50, paddingRight: 50, paddingTop: 15, paddingBottom: 15, fontSize: 20, borderRadius: 10, background: "#77af9c", color: 'white', marginLeft: 200, fontWeight: 'bold', border: 'solid 3px #2e8b57' }}>送信</button>
            </div>
        </div >
    )
}
